...
<link rel="stylesheet" href="<?php echo base_url('public/common/dist/css/skins/_all-skins.min.css')?>">
<link rel="icon" href="<?php echo base_url('public/common/img/logo64.jpg'); ?>" type="image/x-icon"/>
