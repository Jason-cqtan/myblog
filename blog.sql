...
--
-- Host: localhost
-- Generation Time: 2017-08-04 00:54:22
-- 服务器版本： 5.6.35
-- PHP Version: 7.1.1
...
INSERT INTO `article` (`id`, `module_id`, `module_name`, `user_id`, `monthy`, `title`, `brief`, `create_time`, `update_time`, `deleted`, `views`, `platform`, `browserdesc`, `is_sticktop`, `ipaddress`, `remark`, `tag_ids`, `tag_names`, `status`) VALUES
(1, 7, 'php', 1, '2017-08', '士大夫收到', '士大夫收到发送到', 1501761300, 1501761300, 0, 1, 'Windows 7', 'Chrome 60.0', 0, '重庆市电信', '士大夫收到', '17', 'gd2', 1),
(2, 4, 'css3', 1, '2017-08', '这是标题', '发送到发送到发送到', 1501761359, 1501761359, 0, 1, 'Windows 7', 'Chrome 60.0', 0, '重庆市电信', '士大夫收到发送到', '6,18', '定位,动画', 1),
(3, 7, 'php', 1, '2017-08', '这是标题', '是打发斯蒂芬士大夫收到是打发斯蒂芬士大夫收到是打发斯蒂芬士大夫收到是打发斯蒂芬士大夫收到', 1501761432, 1501761432, 0, 1, 'Windows 7', 'Chrome 60.0', 0, '重庆市电信', '这是备注', '2,19', 'curl,websokit', 1),
(4, 4, 'css3', 1, '2017-08', 'zheshi basdfgsdf', 'sdfsdf ssdfsdfsdfsdf', 1501761816, 1501761816, 0, 1, 'Windows 7', 'Chrome 60.0', 0, '重庆市电信', 'sdfsdf sd', '18,20', '动画,were', 1),
(5, 5, 'js', 1, '2017-08', 'sdfsdfsdfsdfsdf', '曾经看到过一篇文章，讲到的内容就是个人是如何通过创建一个博客，然后通过日积月累的更新文章，最后在百度中获得了不少的排名，并最终通过百度带的巨大流量中获得联盟广告的收益。现在国内流行恐怕就是：用Word', 1501762150, 1501762150, 0, 1, 'Windows 7', 'Chrome 60.0', 0, '重庆市电信', 'sdfsdfsdf', '1,3', 'ajax,vue', 1);
...
INSERT INTO `mudule` (`id`, `name`, `pid`, `deleted`, `is_tag`, `couldclick`) VALUES
(1, '首页', 0, 0, 0, 1),
(2, '前端', 0, 0, 0, 1),
(3, 'html5', 2, 0, 1, 1),
(4, 'css3', 2, 0, 1, 1),
...
INSERT INTO `tags` (`id`, `name`, `module_id`, `pid`, `for_article`) VALUES
(1, 'ajax', 5, 0, 1),
(2, 'curl', 7, 0, 1),
(3, 'vue', 5, 0, 1),
(4, 'vim', 13, 0, 1),
...
(1, 'tjc', '78354a342d40fc34f3ba825f26527f56', 1, NULL, NULL, NULL, 1501777865, NULL, NULL, NULL, NULL);
